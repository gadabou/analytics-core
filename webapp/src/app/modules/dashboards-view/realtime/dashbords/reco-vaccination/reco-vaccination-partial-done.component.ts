...
@Component({
  standalone: false,
  selector: 'reco-vaccinations-partial-done-dashboard',
  templateUrl: './a-reco-vaccination.component.html',
  styleUrl: './a-reco-vaccination.component.css'
})

export class RecoVaccinationPartialDoneDashboardComponent extends BaseDashboardsComponent<RecoVaccinationDashboard[]> {

  override DASHBOARD_NAME = 'RECOS_VACCINES_PARTIAL_DONE';
  ...
  constructor(private ldbfetch: LocalDbDataFetchService, fGroup: FormGroupService, conn: ConnectivityService, snackbar: SnackbarService, userCtx: UserContextService) {
    super(
      ...
      (formData, isOnline) => {
        ...
        return from(this.ldbfetch.GetRecoVaccinationPartialDoneDashboard(formData, isOnline))
      },
    );
  }
